...
COMMON_DEMUXERS = matroska ogg mov mp3 wav image2 concat gif
COMMON_DECODERS = vp8 h264 vorbis opus mp3 aac pcm_s16le mjpeg png gif

WEBM_MUXERS = webm ogg null gif
WEBM_ENCODERS = libvpx_vp8 libopus gif
